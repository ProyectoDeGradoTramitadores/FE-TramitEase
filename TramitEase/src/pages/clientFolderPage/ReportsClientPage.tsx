                ...
                <Box display="flex" gap={1} justifyContent="center" alignItems="center">
                    ...
                    >
                        <CardInfoClientFolder
                            ...
                            creationDate={clientFolder?.creationDate ?? 'Todavia no se inicio el Tramite'}
                            endProcedure={clientFolder?.endDate ?? 'Tramite en Progreso'}
                            estimateDate={metricsClientFolder?.endEstimateDate &&
                            metricsClientFolder?.endEstimateDate?.toString() !== "Invalid Date" ?
                                metricsClientFolder?.endEstimateDate?.toString()  :
                                'Todavia el Tramite no se inicio'}
